...
@decorator
def cputime(f: Any, *args, **kwargs):  # type:ignore[misc,no-untyped-def]
    """Display CPU Time statistics of given function."""

    print(
        "CPU time for {}{}{}:".format(
            Fore.CYAN, _get_scope(f, args), Fore.RESET
        )
    )
...
@decorator
def docs(f, *args, **kwargs):  # type:ignore[no-untyped-def]
...
@decorator
def time(f, *args, **kwargs):  # type:ignore[no-untyped-def]
    """Display Runtime statistics of given function."""

    print(
        "Execution speed of %s%s%s:"
        % (Fore.CYAN, _get_scope(f, args), Fore.RESET)
    )
    _t0 = now()
    _r = f(*args, **kwargs)
...
@decorator
def trace(f, *args, **kwargs):  # type:ignore[no-untyped-def]
...
def _get_scope(f, args):  # type:ignore[no-untyped-def]
